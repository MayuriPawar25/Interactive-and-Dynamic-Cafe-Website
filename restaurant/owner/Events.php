...
<head>
  ...
  <title>Event-Engineer's Chai</title>
...
<section class="panel">
                  ...
                  <td><?php echo "EC".$i ?></td>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <a class="btn btn-primary" data-toggle="modal" href="#myModal" name="event_id" onclick="edit(<?php echo ($row['id']);?>)"><i class="icon_pencil-edit_alt"></i></a>                        
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" id="focusedInput" type="text" name="name" placeholder="Enter Event Name..." onkeypress="return /[a-z _]/i.test(event.key);" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">                  
                    ...
                    <div class="col-sm-2">
                    <div class="radios">                        
                          <span><input name="sample-radio" id="radio-01" value="free" onclick="radio1()" type="radio" /> Free </span>
                          <span><input name="sample-radio" id="radio-02" value="paid" onclick="radio2()" type="radio" /> Paid </span>
                    </div>
                  </div>
                    <div class="col-sm-1">
                      <input class="form-control price" id="price" type="number" name="price" placeholder="Price" pattern=".{1,4}" max="3000"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  title="price not more than 3000">
                    </div>                  
                  ...
                  <div class="form-group">                    
                    ...
                    <button class="btn btn-primary text-center" type="submit" name="addevent">Sumbit</button>
                    </div>
                  </div>
                  </form>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <form class="form-horizontal" method="GET">
                        ...
                        <button class="btn btn-danger" type="submit" name="deleteevent" id="deleteevent">Delete</button>                          
                      </form>
                      </div>
                    </div>
                  </div>
 ...
 xhttp = new XMLHttpRequest();
  ...
  xhttp.open("GET", "data.php?editevent="+event_id, true);
  xhttp.send(); 
}

function rmmenu(event_id) {
