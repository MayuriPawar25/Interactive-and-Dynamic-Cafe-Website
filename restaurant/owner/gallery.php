...
<head>
  ...
  <title>Gallery-Engineer's Chai</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-list-alt"></i> Gallery</h3>
          </div>
        </div>
...
<section class="panel">
              ...
              <div class="panel-body">
                ...
                <tbody>
                  ...
                  <?php $i = 1; while($row=mysqli_fetch_assoc($image_table)){?>
                  <tr>
                  <td><?php echo "EC".$i ?></td>
                    <td><?php echo ucfirst($row["menuname"]);?></td>
                    <td><img height="150px" width="150px" src="../assets/img/gallery/<?php echo $row["img_name"];?>"></td>
                    <td><?php echo ($row["img_status"]);?></td>
                    <td>
                      
                      <div class="btn-group">
                        
                        <a class="btn btn-primary" data-toggle="modal" href="#myModal" name="image_id" onclick="edit(<?php echo ($row['id']);?>)"><i class="icon_pencil-edit_alt"></i></a>                        
                        <a class="btn btn-danger" data-toggle="modal" href="#myModal3" onclick="rmimage(<?php echo ($row['id']);?>)"><i class="icon_close_alt2"></i></a>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input class="form-control" id="focusedInput" type="text" name="image_name" placeholder="Enter Image Name..." onkeypress="return /[a-z _]/i.test(event.key);">
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">                    
                    ...
                    <button class="btn btn-primary text-center" type="submit" name="addimage">Sumbit</button>
                    </div>
                  </div>
                  </form>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <form class="form-horizontal" method="GET">
                        ...
                        <button class="btn btn-danger" type="submit" name="deleteimage" id="deleteimage">Delete</button>                          
                      </form>
                      </div>
                    </div>
                  </div>
 ...
 xhttp = new XMLHttpRequest();
  ...
  xhttp.open("GET", "data.php?editimage="+image_id, true);
  xhttp.send(); 
}

function rmimage(image_id) {
  document.getElementById("deleteimage").value = image_id;
}
...
xhttp = new XMLHttpRequest();
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("menutable").innerHTML = "fdhghs";
    }
  };
